...
boost_monster_hp {
  ...
  var %level = $calc((%str + %def + %int + %spd / 2) / 17.5)
  var %average_HP = $calc(50 + %level * 5)
  var %ratio = $calc(%hp / %average_HP)
  ; Cap the health.
  if ($isfile($boss($1))) {
    if (%ratio < 1) %ratio = 1
    else if (%ratio > 2.5) %ratio = 2.5  
  }
  else {
  ...
  %hp = $calc($round($calc((60 + $3 * 20) * %ratio / 10), 1) * 10)
  writeini $char($1) BaseStats HP %hp  
}

boost_monster_hp_old {
  ; $1 = monster
...
display_damage {
  ...
  if (%double.attack = true) { 
    if (%guard.message = $null) {  var %damage.message The first attack %attack_effect1 $+ .  The second attack %attack_effect2 $+ .  Total damage: $+ %damage.display.color $+  $bytes(%attack.damage,b)  $+ %style.rating 
  ...
  if (%triple.attack = true) {  
    if (%guard.message = $null) { var %damage.message The first attack %attack_effect1 $+ .  The second attack %attack_effect2 $+ .  The second attack %attack_effect3 $+ .  Total damage: $+ %damage.display.color $+  $bytes(%attack.damage,b)  $+ %style.rating
      $display.message(%damage.message,battle)
    }
    if (%guard.message != $null) { $display.message(%guard.message,battle)  }
    unset %attack.damage1 | unset %attack.damage2 | unset %attack.damage3 | unset %attack.damage5 | unset %attack.damage6 | unset %attack.damage7 | unset %attack.damage8 | unset %double.attack | unset %triple.attack | unset %fourhit.attack | unset %fivehit.attack | unset %sixhit.attack | unset %sevenhit.attack | unset %eighthit.attack 
  ...
  if (%fourhit.attack = true) { 
    if (%guard.message = $null) { var %damage.message The first attack %attack_effect1 $+ .  The second attack %attack_effect2 $+ .  The third attack %attack_effect3 $+ . The fourth attack %attack_effect4 $+ . Total damage: $+ %damage.display.color $+  $bytes(%attack.damage,b)  $+ %style.rating
      $display.message(%damage.message,battle)
    }
    if (%guard.message != $null) { $display.message(%guard.message,battle)  }
    unset %attack.damage1 | unset %attack.damage2 | unset %attack.damage3 | unset %attack.damage5 | unset %attack.damage6 | unset %attack.damage7 | unset %attack.damage8 | unset %double.attack | unset %triple.attack | unset %fourhit.attack | unset %fivehit.attack | unset %sixhit.attack | unset %sevenhit.attack | unset %eighthit.attack 
  ...
  if (%fivehit.attack = true) { 
    if (%guard.message = $null) { var %damage.message The first attack %attack_effect1 $+ .  The second attack %attack_effect2 $+ .  The third attack %attack_effect3 $+ . The fourth attack %attack_effect4 $+ . The fifth attack %attack_effect5 $+ . Total damage: $+ %damage.display.color $+  $bytes(%attack.damage,b)  $+ %style.rating 
      $display.message(%damage.message,battle)
    }
    if (%guard.message != $null) { $display.message(%guard.message,battle)  }
    unset %attack.damage1 | unset %attack.damage2 | unset %attack.damage3 | unset %attack.damage5 | unset %attack.damage6 | unset %attack.damage7 | unset %attack.damage8 | unset %double.attack | unset %triple.attack | unset %fourhit.attack | unset %fivehit.attack | unset %sixhit.attack | unset %sevenhit.attack | unset %eighthit.attack 
  ...
  if (%sixhit.attack = true) { 
    if (%guard.message = $null) { var %damage.message The first attack %attack_effect1 $+ .  The second attack %attack_effect2 $+ .  The third attack %attack_effect3 $+ . The fourth attack %attack_effect4 $+ . The fifth attack %attack_effect5 $+ . The sixth attack %attack_effect6 $+ .  Total damage: $+ %damage.display.color $+  $bytes(%attack.damage,b)  $+ %style.rating
      $display.message(%damage.message,battle)
    }
    if (%guard.message != $null) { $display.message(%guard.message,battle)  }
    unset %attack.damage1 | unset %attack.damage2 | unset %attack.damage3 | unset %attack.damage5 | unset %attack.damage6 | unset %attack.damage7 | unset %attack.damage8 | unset %double.attack | unset %triple.attack | unset %fourhit.attack | unset %fivehit.attack | unset %sixhit.attack | unset %sevenhit.attack | unset %eighthit.attack 
  ...
  if (%sevenhit.attack = true) { 
    if (%guard.message = $null) { var %damage.message The first attack %attack_effect1 $+ .  The second attack %attack_effect2 $+ .  The third attack %attack_effect3 $+ . The fourth attack %attack_effect4 $+ . The fifth attack %attack_effect5 $+ . The sixth attack %attack_effect6 $+ . The seventh attack %attack_effect7 $+ .  Total damage: $+ %damage.display.color $+  $bytes(%attack.damage,b)  $+ %style.rating 
      $display.message(%damage.message,battle)
    }
    if (%guard.message != $null) { $display.message(%guard.message,battle)  }
    unset %attack.damage1 | unset %attack.damage2 | unset %attack.damage3 | unset %attack.damage5 | unset %attack.damage6 | unset %attack.damage7 | unset %attack.damage8 | unset %double.attack | unset %triple.attack | unset %fourhit.attack | unset %fivehit.attack | unset %sixhit.attack | unset %sevenhit.attack | unset %eighthit.attack 
  ...
  if (%eighthit.attack = true) { 
    if (%guard.message = $null) { var %damage.message The first attack %attack_effect1 $+ .  The second attack %attack_effect2 $+ .  The third attack %attack_effect3 $+ . The fourth attack %attack_effect4 $+ . The fifth attack %attack_effect5 $+ . The sixth attack %attack_effect6 $+ . The seventh attack %attack_effect7 $+ .  The eighth attack %attack_effect8 $+ . Total damage: $+ %damage.display.color $+  $bytes(%attack.damage,b)  $+ %style.rating
      $display.message(%damage.message,battle)
    }
    if (%guard.message != $null) { $display.message(%guard.message,battle)  }
    unset %attack.damage1 | unset %attack.damage2 | unset %attack.damage3 | unset %attack.damage5 | unset %attack.damage6 | unset %attack.damage7 | unset %attack.damage8 | unset %double.attack | unset %triple.attack | unset %fourhit.attack | unset %fivehit.attack | unset %sixhit.attack | unset %sevenhit.attack | unset %eighthit.attack 
...
hit_check {
  ...
  if (%r > %hit) {
    ...
    ; Missing costs some style points.
    var %stylepoints = $readini($txtfile(battle2.txt), style, $1)  
    writeini $txtfile(battle2.txt) style $1 $calc(%stylepoints * 0.8)

    set %guard.message $readini(translation.dat, battle, Miss)
    set -u0 %attack_effect missed
  }
}
trickster_dodge_check {
  ...
  if (%dodge.chance <= %current.playerstyle.level) {
    ...
    set -u0 %attack_effect was dodged
...
weapon_parry_check {
  ...
  set -u0 %attack_effect was parried
...
counter_melee_action {
  ...
  if ((%weapon.element != $null) && (%weapon.element != none)) {
    modifier_adjust $1 %weapon.element
  }
...
metal_defense_check {
  ; MOD: Metal defense won't save you from critical hits!
  if (($augment.check($2, IgnoreMetalDefense) == true) || (%defense <= 0)) { return }
  else { 
    ; MOD: Set damage against metal defense to 1 instead of 0.
    if ($readini($char($1), info, MetalDefense) = true) {  set %attack.damage 1 }
    return
  }
}
...
melee.ethereal.check {
  if ($readini($char($3), status, ethereal) = yes) {
    if ((($readini($dbfile(weapons.db), $2, HurtEthereal) != true) && ($augment.check($1, HurtEthereal) = false) && ($readini($char($1), skills, FormlessStrike.on) != on))) {
      set -u0 %attack_effect went right through | set -u0 %nopass $true
...
utsusemi.check {
  ...
  if (%utsusemi.flag = on) {
    ...
    set -u0 %attack_effect was avoided by Utsusemi
...
royalguard.check {
  ...
  if ($readini($char($3), skills, royalguard.on) = on) { 
    ...
    set %attack_effect hit Royal Guard
...
perfectdefense.check {
  ...
  if ($readini($char($3), skills, perfectdefense.on) = on) { 
    ...
    set %attack_effect hit Perfect Defense
...
invincible.check {
  ...
  if ($readini($char($3), status, invincible) = yes) { 
    set -u0 %attack_effect was futile | set -u0 %nopass $true
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; MOD: Have this return a value, and possibly block healing techniques against zombies.
covercheck {
  ; $3 = AOE for AOE stuff
  ...
  if ((%cover.target = none) || (%cover.target = $null)) { set %attack.target $1 | return $false } 

  var %cover.status $readini($char(%cover.target), battle, status)
  if ((%cover.status = dead) || (%cover.status = runaway)) { writeini $char($1) skills CoverTarget none | set %attack.target $1 | return $false } 
...
multi_strike_check {
  ...
  if ($1 > 1) {
    ...
    var %strike = 1
    while (%strike <= $1) {
      inc %attack.damage %attack.damage [ $+ [ %strike ] ]
      inc %strike
    }

    if      ($1 == 2) set %double.attack true
    else if ($1 == 3) set %triple.attack true
    else if ($1 == 4) set %fourhit.attack true
    else if ($1 == 5) set %fivehit.attack true
    else if ($1 == 6) set %sixhit.attack true
    else if ($1 == 7) set %sevenhit.attack true
    else if ($1 == 8) set %eighthit.attack true
...
modifier_adjust {
  ...
  if (%modifier.adjust.value > 1) {
    if ($2 isin fire.ice.water.lightning.wind.earth.light.dark) set %damage.display.color 7
  ...
  if (%modifier.adjust.value < 1) {
    if ($2 isin fire.ice.water.lightning.wind.earth.light.dark) if (%damage.display.color != 7) set %damage.display.color 6
